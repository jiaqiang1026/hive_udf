 ...
 * 2012.02.19
 */
public class GetMainDomainUDF extends UDF {
	...
	public static void main(String[] args) {
		...
		String url = "http://www.fun.tv/sport/abc.html";
		GetMainDomainUDF udf = new GetMainDomainUDF();
		System.out.println(udf.getDomainName(url));
	}
}
